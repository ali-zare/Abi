...
{
    public sealed class DatabasePreparedQuery<TParameter>
    {
        static DatabasePreparedQuery()
        {
            CommandTextBuilder = GetCommandTextBuilder();
        }
        internal DatabasePreparedQuery(EntityDatabaseConnection Connection, TParameter Parameter)
        {
            parameter = Parameter;
    ...
    public sealed class DatabasePreparedQuery
    {
        internal DatabasePreparedQuery(EntityDatabaseConnection Connection)
        {
            connection = Connection;
        }
        ...
        public DatabasePreparedQuery<TParameter> WithParameters<TParameter>(TParameter parameter)
        {
            return new DatabasePreparedQuery<TParameter>(connection, parameter);
        }
        public DatabaseQuery Query(string commandText)
        {

...
{
    public sealed class EntityDatabasePreparedSelect<TEntityContext, TEntity, TParameter> where TEntityContext : EntityContext<TEntityContext> where TEntity : Entity<TEntity>
    {
        static EntityDatabasePreparedSelect()
        {
            CommandTextBuilder = GetCommandTextBuilder();
        }
        internal EntityDatabasePreparedSelect(EntityDatabaseConnection Connection, TParameter Parameter)
        {
            parameter = Parameter;
    ...
    public sealed class EntityDatabasePreparedSelect<TEntityContext, TEntity> where TEntityContext : EntityContext<TEntityContext> where TEntity : Entity<TEntity>
    {
        internal EntityDatabasePreparedSelect(EntityDatabaseConnection Connection)
        {
            connection = Connection;
        }
        ...
        public EntityDatabasePreparedSelect<TEntityContext, TEntity, TParameter> WithParameters<TParameter>(TParameter parameter)
        {
            return new EntityDatabasePreparedSelect<TEntityContext, TEntity, TParameter>(connection, parameter);
        }
        public EntityDatabaseSelect<TEntityContext, TEntity> Select(string commandText)
        {
